...
You have an issue using {{site.data.keyword.dns_short_notm}} and need to generate a HAR file for Support.
{: tsCauses}
...
1. In Firefox, go to the page within {{site.data.keyword.dns_short_notm}} where you are experiencing trouble.
...
1. Refresh the {{site.data.keyword.dns_short_notm}} page that you are on, or go through the steps to reproduce the problem you've been experiencing while Firefox is recording activity.
...
1. In Chrome, go to the page within {{site.data.keyword.dns_short_notm}} where you are experiencing trouble.
...
1. Refresh the {{site.data.keyword.dns_short_notm}} page you are on or go through the steps to reproduce the problem you've been experiencing while Chrome is recording activity.
...
1. In Safari, go to the page within {{site.data.keyword.dns_short_notm}} where you are experiencing trouble.
...
1. Refresh the {{site.data.keyword.dns_short_notm}} page that you are on or go through the steps to reproduce the problem you've been experiencing while Safari is recording activity.
...
1. In Microsoft Edge, go to the page within {{site.data.keyword.dns_short_notm}} where you are experiencing trouble.
...
1. Refresh the {{site.data.keyword.dns_short_notm}} page you are on or go through the steps to reproduce the problem you've been experiencing while Edge is recording activity.
