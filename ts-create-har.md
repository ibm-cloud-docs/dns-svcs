...
1. Refresh the CIS page that you are on, or go through the steps to reproduce the problem you've been experiencing while Firefox is recording activity.
...
1. Refresh the CIS page you are on or go through the steps to reproduce the problem you've been experiencing while Chrome is recording activity.
...
1. In Safari, go to the page within CIS where you are experiencing trouble.
...
1. Refresh the CIS page that you are on or go through the steps to reproduce the problem you've been experiencing while Safari is recording activity.
...
1. In Microsoft Edge, go to the page within CIS where you are experiencing trouble.
...
1. Refresh the CIS page you are on or go through the steps to reproduce the problem you've been experiencing while Edge is recording activity.
